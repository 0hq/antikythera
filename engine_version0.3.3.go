...
type t_engine_0dot3dot3 struct {
	EngineClass
...
var engine_0dot3dot3 = t_engine_0dot3dot3{
	EngineClass{
		name: "Engine 0.3.3",
...
func (e *t_engine_0dot3dot3) Run_Engine(pos *chess.Position) (best *chess.Move, eval int) {
...
func (e *t_engine_0dot3dot3) minimax_id_ab_q_starter(position *chess.Position, depth int, max bool) (best *chess.Move, eval int) {
...
func (e *t_engine_0dot3dot3) minimax_id_ab_q_searcher(position *chess.Position, ply int, depth int, max bool, alpha int, beta int) (eval int) {
...
func (e *t_engine_0dot3dot3) quiescence_minimax_id_ab_q(position *chess.Position, depthcount int, max bool, alpha int, beta int) (eval int) {
	explored++
	q_explored++
...
func (e *t_engine_0dot3dot3) Add_Zobrist_History(hash uint64) {
	e.zobristHistoryPly++
	e.zobristHistory[e.zobristHistoryPly] = hash
}

// decrements ply counter, which means history will be overwritten
func (e *t_engine_0dot3dot3) Remove_Zobrist_History() {
	e.zobristHistoryPly--
}

func (e *t_engine_0dot3dot3) Is_Draw_By_Repition(hash uint64) bool {
...
func (e *t_engine_0dot3dot3) Reset(position *chess.Position) {
	e.tt.Clear()
	e.tt.Resize(64, 16)
	e.time_up = false
...
func (e *t_engine_0dot3dot3) Print_Iterative_Deepening(depth int, best *chess.Move, eval int) {
	if QUIET_MODE {
		return
	}
...
func (e *t_engine_0dot3dot3) Print_Start() {
	if QUIET_MODE {
		return
	}
	out("Starting", e.name)
...
func (e *t_engine_0dot3dot3) Print_End(best *chess.Move, eval int) {
	if QUIET_MODE {
		return
	}
