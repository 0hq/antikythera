...
type t_engine_0dot2dot1 struct {
	EngineClass
	killer_moves [MAX_DEPTH][2]*chess.Move
	current_depth int
}

var engine_0dot2dot1 = t_engine_0dot2dot1{
	EngineClass{
		name: "Engine 0.2.1",
...
func (e *t_engine_0dot2dot1) Run_Engine(pos *chess.Position) (best *chess.Move, eval int) {
...
func (e *t_engine_0dot2dot1) minimax_id_ab_q_starter(position *chess.Position, ply int, max bool) (best *chess.Move, eval int) {
...
func (e *t_engine_0dot2dot1) minimax_id_ab_q_searcher(position *chess.Position, ply int, max bool, alpha int, beta int) (eval int) {
	explored++
...
func (e *t_engine_0dot2dot1) quiescence_minimax_id_ab_q(position *chess.Position, plycount int, max bool, alpha int, beta int) (eval int) {
	explored++
	q_explored++
...
func (e *t_engine_0dot2dot1) Reset(pos *chess.Position) {
	e.time_up = false
	e.killer_moves = [MAX_DEPTH][2]*chess.Move{}
	e.current_depth = 0
}

func (e *t_engine_0dot2dot1) Print_Start() {
	out("Starting", e.name)
	// out("Killer moves", e.killer_moves)
	out("Duration:", e.time_duration)
}

func (e *t_engine_0dot2dot1) Print_End(best *chess.Move, eval int) {
